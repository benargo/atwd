...
<body>
	...
	<div class="container">
		...
		<article class="sixteen columns">
			...
			<form id="upload" action="xml-iterator" method="POST">
				<input type="hidden" name="MAX_FILE_SIZE" value="32000">
				<input type="hidden" name="year" value="6-2013">
				<p>Enter the URL of an XML file</p>
				<p><input type="text" name="xml" placeholder="http://www.cems.uwe.ac.uk/~b2-argo/atwd/data/recorded_crime.xml" class="twelve columns" /> <input type="submit" value="Go" /></p></p>
			</form>
